...
describe("Message Converter Integration Tests", () => {
  ...
  describe("Basic Message Conversion", () => {
    test("should convert simple text message to SMTP format", () => {
    ...
    test("should handle multiple recipients in envelope", () => {
      const message = createTestMessage({
        recipients: [
  ...
  describe("Content Type Handling", () => {
    test("should create single-part HTML message", () => {
      const message = createTestMessage({
    ...
    test("should create multipart/alternative for mixed content", () => {
      const message = createTestMessage({
        content: {
  ...
  describe("Attachment Handling", () => {
    test("should create multipart/mixed with single attachment", () => {
    ...
    test("should handle inline attachments with Content-ID", () => {
    ...
    test("should handle mixed content with attachments", () => {
  ...
  describe("Header Encoding", () => {
    test("should encode non-ASCII headers with RFC 2047", () => {
      const message = createTestMessage({
    ...
    test("should leave ASCII headers unchanged", () => {
      const message = createTestMessage({
  ...
  describe("Content Encoding", () => {
    test("should use quoted-printable for text content", () => {
      const message = createTestMessage({
    ...
    test("should handle special characters in quoted-printable", () => {
      const message = createTestMessage({
        content: { text: "End=" },
      });
  ...
  describe("Priority and Custom Headers", () => {
    test("should add priority headers for high priority", () => {
      const message = createTestMessage({
        priority: "high",
      });
    ...
    test("should add priority headers for low priority", () => {
      const message = createTestMessage({
        priority: "low",
      });
    ...
    test("should not add priority headers for normal priority", () => {
      const message = createTestMessage({
        priority: "normal",
      });
    ...
    test("should handle reply-to addresses", () => {
      const message = createTestMessage({
        replyRecipients: [
  ...
  describe("Message ID Generation", () => {
    ...
    test("should generate valid date headers", () => {
      const message = createTestMessage();
      const result = convertMessage(message);
  ...
  describe("Edge Cases", () => {
    ...
    test("should handle message with no To recipients", () => {
      const message = createTestMessage({
    ...
    test("should handle very long lines in content", () => {
