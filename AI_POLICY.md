...
The Upyo project has the following rules for AI usage:
...
These rules apply only to outside contributions to Upyo.  Maintainers are
...
Please remember that Upyo is maintained by humans.
...
Upyo is written with plenty of AI assistance, and many maintainers embrace
